...
class TestAppRoutersBondTokensTokenAddressRedeemBatchGET:
    ...
    def test_normal_2(self, client, db):
        ...
        redeem_upload1.token_type = TokenType.IBET_STRAIGHT_BOND.value
    ...
    def test_normal_3_1(self, client, db):
        ...
        redeem_upload2.token_type = TokenType.IBET_STRAIGHT_BOND.value
        ...
        redeem_upload3.token_type = TokenType.IBET_STRAIGHT_BOND.value
        ...
        redeem_upload4.token_type = TokenType.IBET_STRAIGHT_BOND.value
        ...
        redeem_upload5.token_type = TokenType.IBET_STRAIGHT_BOND.value
