...
class TestRecordLog:
    ...
    # <Normal_1>
    def test_normal_1(self, db, freeze_log_contract):
        ...
        # Run Test
        tx_hash, log_index = FreezeLogContract(
    ...
    # <Error_1>
    # Transaction Error
    def test_error_1(self, db, freeze_log_contract):
        user = config_eth_account("user1")
        user_address = user["address"]
    ...
    # <Error_2>
    # Transaction Timeout
    def test_error_2(self, db, freeze_log_contract):
        user = config_eth_account("user1")
        user_address = user["address"]
...
class TestUpdateLog:
    ...
    def test_normal_1(self, db, freeze_log_contract):
        ...
        tx_hash, log_index = log_contract.record_log(
            log_message="before message", freezing_grace_block_count=100
        )
        _ = log_contract.update_log(log_index=log_index, log_message="after message")
...
class TestGetLog:
    ...
    def test_normal_1(self, db, freeze_log_contract):
        ...
        _block_number, _grace_block_count, _log_message = log_contract.get_log(
            log_index
        )
    ...
    # <Normal_2>
    # Default value
    def test_normal_2(self, db, freeze_log_contract):
        user = config_eth_account("user1")
        user_address = user["address"]
        ...
        _block_number, _grace_block_count, _log_message = log_contract.get_log(9999999)
