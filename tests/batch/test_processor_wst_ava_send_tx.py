...
from batch.processor_wst_ava_send_tx import LOG, ProcessorAvaWSTSendTx
...
class TestProcessor:
    ...
    @mock.patch(
        "batch.processor_wst_ava_send_tx.AVA_MASTER_ACCOUNT_ADDRESS",
        eth_master["address"],
    )
    @mock.patch(
        "batch.processor_wst_ava_send_tx.AVA_MASTER_PRIVATE_KEY",
