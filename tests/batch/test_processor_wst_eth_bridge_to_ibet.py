...
from batch.processor_wst_eth_bridge_to_ibet import (
    LOG,
    EthWSTBridgeToIbetProcessor,
)
...
def processor(async_db, caplog: pytest.LogCaptureFixture):
    ...
    log.propagate = True
    yield EthWSTBridgeToIbetProcessor()
    log.propagate = False
...
class TestProcessor:
    ...
    @mock.patch(
        "batch.processor_wst_eth_bridge_to_ibet.IbetSecurityTokenInterface.force_unlock",
        AsyncMock(
            side_effect=[
                (
                    "test_tx_hash_1",
    ...
    @mock.patch(
        "batch.processor_wst_eth_bridge_to_ibet.IbetSecurityTokenInterface.force_change_locked_account",
        AsyncMock(
            side_effect=[
                (
                    "test_tx_hash_1",
