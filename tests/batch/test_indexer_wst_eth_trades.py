...
from batch.indexer_wst_eth_trades import Processor
...
class TestProcessor:
    ...
    async def test_normal_1_1(
        ...
        synced_block_number: IDXEthIbetWSTTradeBlockNumber | None = (
    ...
    @mock.patch(
        "batch.indexer_wst_eth_trades.EthAsyncContractUtils.get_event_logs",
        AsyncMock(
            side_effect=[
    ...
    @mock.patch(
        "batch.indexer_wst_eth_trades.EthereumIbetWST.get_trade",
        AsyncMock(
    ...
    async def test_normal_2_1(
        ...
        wst_trade: IDXEthIbetWSTTrade | None = (
    ...
    async def test_normal_3(
        ...
        wst_trade: Sequence[IDXEthIbetWSTTrade] = (
            await async_db.scalars(
