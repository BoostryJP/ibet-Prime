...
class TestListBondTokenLockUnlockEvents:
    # target API endpoint
    ...
    def test_normal_2(self, mock_IbetStraightBondContract_get, client, db):
        ...
        # mock
        mock_IbetStraightBondContract_get.side_effect = self.get_contract_mock_data(
    ...
    # token_status
    @mock.patch("app.model.blockchain.token.IbetStraightBondContract.get")
    def test_normal_3(self, mock_IbetStraightBondContract_get, client, db):
        # prepare data
