...
class TestListAllBatchAdditionalBondIssue:
    # target API endpoint
    base_url = "/bond/tokens/{}/additional_issue/batch"
    ...
    async def test_normal_2(self, async_client, async_db):
        ...
        additional_issue_upload1.category = BatchIssueRedeemProcessingCategory.ISSUE
    ...
    async def test_normal_3_1(self, async_client, async_db):
        ...
        additional_issue_upload2.category = BatchIssueRedeemProcessingCategory.ISSUE
        ...
        additional_issue_upload3.category = BatchIssueRedeemProcessingCategory.ISSUE
        ...
        additional_issue_upload4.category = BatchIssueRedeemProcessingCategory.ISSUE
        ...
        additional_issue_upload5.category = BatchIssueRedeemProcessingCategory.ISSUE
