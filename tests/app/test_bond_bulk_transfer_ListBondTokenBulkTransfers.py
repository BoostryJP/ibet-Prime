...
class TestListBondTokenBulkTransfers:
    # target API endpoint
    ...
    async def test_normal_1_2(self, async_client: AsyncClient, async_db: AsyncSession):
        ...
        assumed_response: list[TestListBondTokenBulkTransfers.UploadResponse] = []
        for i in range(0, 3):
        ...
        sorted_assumed: list[TestListBondTokenBulkTransfers.UploadResponse] = sorted(
    ...
    async def test_normal_2(self, async_client: AsyncClient, async_db: AsyncSession):
        ...
        bulk_transfer_0_0.token_type = TokenType.IBET_STRAIGHT_BOND
        ...
        bulk_transfer_0_1.token_type = TokenType.IBET_STRAIGHT_BOND
        ...
        bulk_transfer_1_0.token_type = TokenType.IBET_STRAIGHT_BOND
        ...
        bulk_transfer_2_0.token_type = TokenType.IBET_STRAIGHT_BOND
