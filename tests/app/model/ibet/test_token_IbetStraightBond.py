...
class TestForcedTransfer:
    ...
    async def test_normal_1(self, async_db: AsyncSession):
        ...
        assert from_balance == int(arguments[2]) - 10
...
class TestBulkForcedTransfer:
    ...
    async def test_normal_1(self, async_db: AsyncSession):
        ...
        from_balance = await bond_contract.get_account_balance(from_address)
        to_balance = await bond_contract.get_account_balance(to_address)
        assert from_balance == int(arguments[2]) - 20
...
class TestBulkTransfer:
    ...
    async def test_normal_1(self, async_db: AsyncSession):
        ...
        assert from_balance == int(arguments[2]) - 10 - 20
...
class TestAdditionalIssue:
    ...
    async def test_normal_1(self, async_db: AsyncSession):
        ...
        assert bond_contract_attr.total_supply == int(arguments[2]) + 10

        balance = await bond_contract.get_account_balance(issuer_address)
        assert balance == int(arguments[2]) + 10
...
class TestBulkAdditionalIssue:
    ...
    async def test_normal_1(self, async_db: AsyncSession):
        ...
        # assertion
        bond_contract_attr = await bond_contract.get()
        assert bond_contract_attr.total_supply == int(arguments[2]) + 20

        balance = await bond_contract.get_account_balance(issuer_address)
        assert balance == int(arguments[2]) + 20
...
class TestApproveTransfer:
    ...
    async def test_error_2(self, async_db: AsyncSession):
        ...
        # Transfer approve
        approve_data: dict[str, Any] = {"application_id": 0, "data": "test_data"}
        _approve_transfer_data = ApproveTransferParams(**approve_data)
...
class TestCancelTransfer:
    ...
    async def test_error_2(self, async_db: AsyncSession):
        ...
        # Transfer cancel
        cancel_data: dict[str, Any] = {"application_id": 0, "data": "test_data"}
    ...
    async def test_error_2_2(self, async_db: AsyncSession):
        ...
        with pytest.raises(SendTransactionError) as exc_info:
            await bond_contract.lock(
                tx_params=LockParams(**lock_data),  # type: ignore
                tx_sender=issuer_address,
                tx_sender_key=cast(bytes, "invalid_pk"),  # invalid pk
            )
