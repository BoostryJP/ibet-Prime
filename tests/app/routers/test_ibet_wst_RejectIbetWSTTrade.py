...
from app.model.wst import IbetWSTDigestHelper
from app.utils.ava_contract_utils import AvaWeb3
from app.utils.eth_contract_utils import EthWeb3
from tests.account_config import default_eth_account

WST_DOMAIN_SEPARATOR = b"\x11" * 32


@pytest.mark.asyncio
class TestRejectIbetWSTTrade:
    # API endpoint
    api_url = "/ibet_wst/trades/{ibet_wst_address}/reject"
    ...
    async def test_normal_1(self, async_db: AsyncSession, async_client: AsyncClient):
        ...
        domain_separator = WST_DOMAIN_SEPARATOR
        ...
        assert wst_tx.tx_type == IbetWSTTxType.REJECT_TRADE
