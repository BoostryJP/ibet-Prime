...
class TestProcessor:
    ...
    def test_normal_3(self, processor, db):
        ...
        _template_1.ledger_admin_headquarters = "ledger_admin_headquarters_test1"
        _template_1.ledger_admin_office_address = "ledger_admin_office_address_test1"
        db.add(_template_1)
        ...
        _template_2.ledger_admin_headquarters = "ledger_admin_headquarters_test2"
        _template_2.ledger_admin_office_address = "ledger_admin_office_address_test2"
        db.add(_template_2)
        ...
        assert _bond_ledger.ledger == {
            ...
            "社債原簿管理人": {
                ...
                "住所": "ledger_admin_headquarters_test1",
                "事務取扱場所": "ledger_admin_office_address_test1"
            },
            "社債権者": [
                {
                    "アカウントアドレス": user_address_1,
        ...
        assert _bond_ledger.ledger == {
            ...
            "社債原簿管理人": {
                ...
                "住所": "ledger_admin_headquarters_test2",
                "事務取扱場所": "ledger_admin_office_address_test2"
            },
            "社債権者": [
                {
                    "アカウントアドレス": user_address_1,
