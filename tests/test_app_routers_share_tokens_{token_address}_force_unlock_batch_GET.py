...
class TestAppRoutersShareTokensTokenAddressForceUnlockBatchGET:
    # target API endpoint
    ...
    def test_normal_2(self, client, db):
        ...
        force_unlock_upload1.token_type = TokenType.IBET_SHARE.value
    ...
    def test_normal_3_1(self, client, db):
        ...
        force_unlock_upload2.token_type = TokenType.IBET_SHARE.value
        ...
        force_unlock_upload3.token_type = TokenType.IBET_SHARE.value
        ...
        force_unlock_upload4.token_type = TokenType.IBET_SHARE.value
        ...
        force_unlock_upload5.token_type = TokenType.IBET_SHARE.value
