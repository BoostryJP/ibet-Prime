...
def upgrade():
    ...
    op.create_index(
        op.f("ix_bulk_transfer_issuer_address"),
        "bulk_transfer",
        ["issuer_address"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_bulk_transfer_upload_id"),
        "bulk_transfer",
        ["upload_id"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_bulk_transfer_upload_issuer_address"),
        "bulk_transfer_upload",
        ["issuer_address"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_bulk_transfer_upload_status"),
        "bulk_transfer_upload",
        ["status"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_idx_personal_info_account_address"),
        "idx_personal_info",
        ["account_address"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_idx_personal_info_issuer_address"),
        "idx_personal_info",
        ["issuer_address"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_idx_position_account_address"),
        "idx_position",
        ["account_address"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_idx_position_token_address"),
        "idx_position",
        ["token_address"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_idx_transfer_token_address"),
        "idx_transfer",
        ["token_address"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_idx_transfer_transaction_hash"),
        "idx_transfer",
        ["transaction_hash"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_idx_transfer_transfer_from"),
        "idx_transfer",
        ["transfer_from"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_idx_transfer_transfer_to"),
        "idx_transfer",
        ["transfer_to"],
        unique=False,
        schema=get_db_schema(),
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_bulk_transfer_upload_status"),
        table_name="bulk_transfer_upload",
        schema=get_db_schema(),
    )
    op.drop_index(
        op.f("ix_bulk_transfer_upload_issuer_address"),
