...
def upgrade():
    ...
    op.create_index(
        op.f("ix_e2e_messaging_account_rsa_key_account_address"),
        "e2e_messaging_account_rsa_key",
        ["account_address"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_e2e_messaging_account_rsa_key_transaction_hash"),
        "e2e_messaging_account_rsa_key",
        ["transaction_hash"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_idx_e2e_messaging_from_address"),
        "idx_e2e_messaging",
        ["from_address"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_idx_e2e_messaging_to_address"),
        "idx_e2e_messaging",
        ["to_address"],
        unique=False,
        schema=get_db_schema(),
    ...
    op.create_index(
        op.f("ix_idx_e2e_messaging_transaction_hash"),
        "idx_e2e_messaging",
        ["transaction_hash"],
        unique=False,
        schema=get_db_schema(),
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_e2e_messaging_account_rsa_key_transaction_hash"),
        table_name="e2e_messaging_account_rsa_key",
        schema=get_db_schema(),
    )
    op.drop_index(
        op.f("ix_e2e_messaging_account_rsa_key_account_address"),
