...
def downgrade():
    ...
    sa.Column('token_address', sa.VARCHAR(length=42), autoincrement=False, nullable=False),
    sa.Column('is_manual_transfer_approval', sa.BOOLEAN(), autoincrement=False, nullable=True),
